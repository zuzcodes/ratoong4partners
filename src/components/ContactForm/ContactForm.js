...
const ContactForm = ({ submitForm }) => {
  const { handleChange, handleSubmit, value, error } = useContact(submitForm, validateContact);
  return (
    <ContactSection>
      <ContactFormContainer>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <ContactFormEmail type="email" name="email" placeholder="Email" value={value.email} onChange={handleChange} />
